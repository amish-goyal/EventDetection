...
class Vocabulary:
    def __init__(self, excluds_stopwords=True, wordfreq_threshold=3):
        #if to word
    ...
    def gen_vocabs(self, corpus, prev_voca, prev_lda):
		...
		#print wordid, vocas[wordid], freq
                if freq < self.wordfreq_threshold:
